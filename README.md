...
[![Chrome Extension](https://img.shields.io/badge/🧩_Chrome_Extension-Download_.ZIP-4285F4?style=for-the-badge&logo=googlechrome&logoColor=white)](https://maheshdakulge.github.io/safeguard_ai_live/safeguard_extension.zip)
...
| 🧩 **Chrome Browser Extension** | Lightweight Chrome Extension that runs in the child's browser, monitors page activity, blocks restricted domains, and sends alerts to Render API. | **[📥 Download Extension (.zip)](https://maheshdakulge.github.io/safeguard_ai_live/safeguard_extension.zip)** • **[Installation Guide](#-chrome-extension-installation--pairing-guide)** |
